...
export function AppShell({
  ...
  return (
    <>
      <div className="pointer-events-none fixed -right-[15%] -top-[10%] -z-10 h-[600px] w-[600px] rounded-full bg-primary/10 opacity-60 blur-[120px]" />
      <div className="mx-auto flex w-full max-w-[1440px] flex-col gap-8 px-4 pb-14 pt-6 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 lg:grid-cols-[228px_minmax(0,1fr)] xl:gap-10">
          <AppSidebar
            title={title}
            description={description}
            items={items}
            className="hidden self-start lg:sticky lg:top-[4.9rem] lg:block"
          />
          <div className="min-w-0 space-y-8 lg:border-l lg:border-white/8 lg:pl-10 xl:pl-12">
