...
export function PublicDataUnavailable({
  ...
  return (
    <div className={cn("surface-panel-strong flex flex-col items-center p-7 text-center sm:p-8", className)}>
      <div className="mb-4 flex size-12 items-center justify-center rounded-[1rem] border border-destructive/18 bg-destructive/10">
